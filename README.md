...
supabase/add_supabase_accounts.sql
```
...
de equipos distintos; el tercero, el inventario de cuentas Supabase free tier
(alias +N). Ver `docs/plan-multi-equipo-ditec.md` y `docs/cuentas-supabase.md`.
