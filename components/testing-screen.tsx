                    ...
                    <div className="mt-3 grid gap-3 text-sm sm:grid-cols-[auto_1fr]">
                      ...
                      <div className="grid gap-1.5 sm:justify-items-end">
                        {[
                          ...
                          url ? (
                            <a key={label} className="inline-flex max-w-full items-start gap-1 break-all text-right font-semibold dia-primary-text dark:text-blue-300" href={url} target="_blank" rel="noreferrer">
